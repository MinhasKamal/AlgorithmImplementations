...
public class PriorityBasedPremitive {
	 ...
	 * @param fileName
	 */
	public void priorityBasedPremitiveImpl(String fileName){
		int noOfProcess;
	...
	public static void main(String[] args) {
		new PriorityBasedPremitive().priorityBasedPremitiveImpl("/thread/Input");
	}
}
