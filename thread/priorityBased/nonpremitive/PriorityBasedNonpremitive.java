...
public class PriorityBasedNonpremitive {
	...
	public static void main(String[] args) {
		new PriorityBasedNonpremitive().priorityBasedNonpremitiveImpl("/thread/Input");
	}
}
