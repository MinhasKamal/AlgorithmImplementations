...
public class ShortestJobFirstNonpremitive {
	...
	public static void main(String[] args) {
		new ShortestJobFirstNonpremitive().shortestJobFirstNonpremitiveImpl("/thread/Input");
	}
}
